...
Each sample is a separate subprocess so a hang in one doesn't poison the
others. Per-script wall-clock timeout enforced via subprocess.run(timeout=...).

Result is written to test-results.log next to this file.
"""
